...
export default function Login(): React.JSX.Element {
    ...
    function onSubmit(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
        e.preventDefault();
        // Handle login logic here, e.g., send loginCredentials to the server

        console.log('Login submitted with credentials:', loginCredentials);

        // might be asynchrous, but for now we will just call the method directly 
        AuthenticationService.signInWithEmailAndPassword(loginCredentials.email, loginCredentials.password);
    }
